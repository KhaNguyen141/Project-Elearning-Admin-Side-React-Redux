        ...
        return (
            ...
            <ul className="nav flex-column bg-white mb-0">
              <li className="nav-item">
                <NavLink activeClassName={"active"} exact to="/admin" className="nav-link textMenu font-italic">
              ...
              <li className="nav-item">
                <NavLink activeClassName={"active"} exact to="/admin/detail" className="nav-link textMenu font-italic">
              ...
              <li className="nav-item">
                <NavLink activeClassName={"active"} exact to="/admin/list-user-manage" className="nav-link textMenu font-italic">
              ...
              <li className="nav-item">
                <NavLink activeClassName={"active"} exact to="/admin/list-course-manage" className="nav-link textMenu font-italic">
                  <ListAltIcon className="menuIcon mr-3" />
              ...
              <li className="nav-item">
                <NavLink activeClassName={"active"} to="/admin/course-manage" className="nav-link textMenu font-italic">
              ...
              <li className="nav-item">
                <NavLink activeClassName={"active"} to="/admin/user-manage" className="nav-link textMenu font-italic">
                  <EditIcon className="menuIcon fa fa-picture-o mr-3" />
                  <span>User Edit</span>
                  <EditIcon className="menuIconResponsive fa fa-picture-o" />
                </NavLink>
