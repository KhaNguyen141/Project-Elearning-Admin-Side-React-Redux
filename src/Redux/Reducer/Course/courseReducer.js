import {LIST_COURSE_PENDING, LIST_COURSE_ACCEPTED, LIST_CATEGORY, LIST_COURSES, LIST_COURSE_PAGINATION, SEARCH_COURSE} from "../../Action/type";
...
const CourseReducer = (state = initialState, action) => {
    switch (action.type) {
        ...
        case SEARCH_COURSE: {
            state.courseText = action.payload;
            return {...state};
        }
